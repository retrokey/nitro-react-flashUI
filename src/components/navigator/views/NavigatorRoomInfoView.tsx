                    ...
                    <>
                        ...
                        <Column gap={ 1 }>
                            ...
                            <Flex justifyContent="center" alignItems="center">
                                <Button variant="illumina" justifyContent="start" className="col-10 mt-2 mb-2" onClick={ () => processAction('report_room') }>
                                    <Base className="flex-shrink-0 icon icon-report-room" />
                                    <Base className="vr" />
                                    <b className="report-text px-2">{ LocalizeText('help.emergency.main.report.room') }</b>
                                </Button>
                            </Flex>
                            { hasPermission('settings') &&
